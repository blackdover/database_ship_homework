...
-- ===== 插入泊位（Berth） =====
INSERT INTO `Berth` (`Berth_ID`,`Port_ID`,`Berth_Name`,`Length_Meters`,`Depth_Meters`) VALUES
(1, 1, 'N1', 1000.00, 500.00),
(2, 1, 'S1', 900.00, 14.00),
(3, 2, 'N2', 800.00, 13.50),
(4, 2, 'S2', 750.00, 12.00),
(5, 3, 'W1', 600.00, 10.00),
(6, 4, 'E1', 500.00, 9.00)
ON DUPLICATE KEY UPDATE `Berth_Name` = `Berth_Name`;
...
(1, 1, 1, 1, 'VN001', 'VN002', '2025-12-10 02:00:00', NULL, 'Approaching'),
(2, 2, 2, 3, 'WH107A', NULL, '2025-11-25 08:30:00', '2025-11-26 17:00:00', 'Completed'),
(3, 3, 4, 6, 'MAH01', 'MAH02', '2025-12-01 12:00:00', NULL, 'AtBerth')
...
INSERT INTO `Task` (`Task_ID`,`Task_Type`,`Status`,`Container_Master_ID`,`From_Slot_ID`,`To_Slot_ID`,`Vessel_Visit_ID`,`Created_By_User_ID`,`Assigned_User_ID`,`Actual_Executor_ID`,`Priority`,`Movement_Timestamp`) VALUES
 ...
 (2, 'Discharge', 'Completed', 2, 2, 3, 2, 2, 2, 2, 90, '2025-11-26 17:00:00'),
...
-- 追加泊位（Berth）7-10 (对应新增港口)
INSERT INTO `Berth` (`Berth_ID`,`Port_ID`,`Berth_Name`,`Length_Meters`,`Depth_Meters`) VALUES
(7, 5, 'GZ-1', 850.00, 12.50),
(8, 6, 'TJ-1', 700.00, 11.00),
(9, 7, 'QD-1', 650.00, 10.00),
(10, 8, 'HK-1', 900.00, 13.50)
ON DUPLICATE KEY UPDATE `Berth_Name` = `Berth_Name`;
...
INSERT INTO `Container_Master` (`Container_Master_ID`,`Container_Number`,`Owner_Party_ID`,`Type_Code`,`Current_Status`) VALUES
 ...
 (7, 'TJNG0077788', 8, '40HC', 'InYard'),
 (8, 'GZPD5566677', 9, '45G1', 'OnVessel'),
 (9, 'HKPT9990001', 10, '20OT', 'InYard'),
 (10,'CMDU4445556',11, '45G1', 'InYard')
ON DUPLICATE KEY UPDATE `Container_Number` = `Container_Number`;
...
-- 追加船舶访问（Vessel_Visit）4-6（关联到对应泊位）
INSERT INTO `Vessel_Visit` (`Vessel_Visit_ID`,`Vessel_ID`,`Port_ID`,`Berth_ID`,`Voyage_Number_In`,`Voyage_Number_Out`,`ATA`,`ATD`,`Status`) VALUES
(4, 4, 4, 6, 'CGM100', 'CGM101', '2025-10-12 06:00:00', '2025-10-13 18:00:00', 'Completed'),
(5, 5, 5, 7, 'EGR200', 'EGR201', '2025-12-05 10:00:00', NULL, 'AtBerth'),
(6, 6, 8, 10, 'HLO300', 'HLO301', '2025-11-20 09:00:00', '2025-11-21 20:00:00', 'Completed')
ON DUPLICATE KEY UPDATE `Vessel_Visit_ID` = `Vessel_Visit_ID`;
...
-- 追加任务（Task）4-6
INSERT INTO `Task` (`Task_ID`,`Task_Type`,`Status`,`Container_Master_ID`,`From_Slot_ID`,`To_Slot_ID`,`Vessel_Visit_ID`,`Created_By_User_ID`,`Assigned_User_ID`,`Actual_Executor_ID`,`Priority`,`Movement_Timestamp`) VALUES
(4, 'GateOut', 'Pending', 5, 5, 6, NULL, 6, 6, NULL, 80, NULL),
(5, 'Load', 'Completed', 8, 8, 2, 5, 2, 7, 7, 110, '2025-12-05 15:30:00'),
