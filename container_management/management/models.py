...
class Party(models.Model):
    ...
    party_type = models.CharField(max_length=20, db_column='Party_Type', choices=[('COMPANY', '公司'), ('PERSON', '个人')], verbose_name='类型')
...
class YardBlock(models.Model):
    ...
    block_type = models.CharField(max_length=20, default='Standard', db_column='Block_Type', verbose_name='类型')
...
class YardSlot(models.Model):
    ...
    slot_status = models.CharField(max_length=20, default='Available', db_column='Slot_Status', verbose_name='状态')
...
class VesselVisit(models.Model):
    ...
    status = models.CharField(max_length=20, default='Approaching', db_column='Status', 
...
class Booking(models.Model):
    ...
    status = models.CharField(max_length=20, default='Draft', db_column='Status', 
                             ...
                             verbose_name='状态')
    shipper_party_id = models.ForeignKey(Party, on_delete=models.SET_NULL, null=True, blank=True, 
                                        related_name='shipper_bookings', db_column='Shipper_Party_ID', verbose_name='发货人')
    consignee_party_id = models.ForeignKey(Party, on_delete=models.SET_NULL, null=True, blank=True, 
                                           related_name='consignee_bookings', db_column='Consignee_Party_ID', verbose_name='收货人')
    payer_party_id = models.ForeignKey(Party, on_delete=models.SET_NULL, null=True, blank=True, 
                                      related_name='payer_bookings', db_column='Payer_Party_ID', verbose_name='付费方')
...
class Task(models.Model):
    ...
    task_type = models.CharField(max_length=30, db_column='Task_Type', 
